...
- [Как HTTPS обеспечивает безопасность соединения: что должен знать каждый Web-разработчик](https://habr.com/ru/articles/188042/)
...
- [Fetch API Request Mode](https://developer.mozilla.org/en-US/docs/Web/API/Request/mode)
...
- [A Deep Dive into Just-In-Time Compilation in V8 JavaScript Engine](https://www.technologyies.com/a-deep-dive-into-just-in-time-compilation-in-v8-javascript-engine/)
